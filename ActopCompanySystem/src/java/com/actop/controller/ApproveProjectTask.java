 ...
 */
@WebServlet(name="ApproveProjectTask", urlPatterns={"/ApproveProjectTask"})
public class ApproveProjectTask extends HttpServlet {
    private int id;
    ...
    throws ServletException, IOException {
        ...
        if(request.getParameter("approval")!=null){
            ...
            am.approveProjectTask(id, note, approval);
        }
        request.getRequestDispatcher("/approvals").forward(request, response);
    }
