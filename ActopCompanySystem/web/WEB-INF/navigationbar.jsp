<div class="navbar navbar-info">
  ...
  <div class="navbar-collapse collapse navbar-material-light-blue-collapse">
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        <a href="index.html" data-target="#" class="dropdown-toggle" data-toggle="dropdown">Projects <b class="caret"></b></a>
...
<!--          <li class="divider"></li>
      ...
      <li class="dropdown">
        <a href="index.html" data-target="#" class="dropdown-toggle" data-toggle="dropdown">Payments <b class="caret"></b></a>
        <ul class="dropdown-menu">
          <li><a href="javascript:void(0)">Other</a></li>
          <li><a href="javascript:void(0)">Salary</a></li>
...
<!--          <li class="divider"></li>
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="dropdown">
        <a href="index.html" data-target="#" class="dropdown-toggle" data-toggle="dropdown">Attendance <b class="caret"></b></a>
        <ul class="dropdown-menu">
          <li><a href="javascript:void(0)">Staff Profile</a></li>
